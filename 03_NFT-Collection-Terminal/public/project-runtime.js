...
(() => {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll("[data-project-mascot]").forEach((e) => {
      ...
      if (!currentSrc) {
        const assetRoot = ["/", "/nft/assets/"].join("");
        ...
        else if (configuredMascot.startsWith("/nft/assets/")) e.src = `/nft/${configuredMascot}`;
    ...
    document.documentElement.style.setProperty("--nft-terminal-label", '"NFT MARKET UPDATE"');
